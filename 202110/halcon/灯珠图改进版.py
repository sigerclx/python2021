...
#ImageFiles = ha.list_files (r'.\现场照片', ['files','follow_links'])
#ImageFiles = ha.tuple_regexp_select (ImageFiles, ['\\.(tif|tiff|gif|bmp|jpg|png)$','ignore_case'])
...
ha.write_image(ImageRGB, 'png', 0, './result/01' )
